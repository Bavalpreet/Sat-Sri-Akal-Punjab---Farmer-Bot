...
# File variables 
input_file_name = "/home/ubuntu/SSA/Diff_Bot_setup/FourteenBot/citrus-pun/CSV/citrus_google_pun_hi_validated.csv"
nlu_output_filename = "data/nlu-faq-hort-citrus-b0-pun.yml"
domain_output_filename = "domain-grp/domain-hort-citrus-b0-pun.yml"

# Intant name variable
intent_name = "faq-hort-citrus-b0-pun"

pp = pprint.PrettyPrinter(indent=4)
data = pd.read_csv(input_file_name)

# print(data.columns)
# ['questions', 'answers', 'Google_Question_punjabi', 'Google_Answer_punjabi']
