...
# File variables 
input_file_name = "/home/ubuntu/SSA/Diff_Bot_setup/FourteenBot/garlic-pun/CSV/garlic_google_pun_hi.xlsx - Sheet1.csv"
nlu_output_filename = "data/nlu-faq-hort-garlic-b0-pun.yml"
domain_output_filename = "domain-grp/domain-hort-garlic-b0-pun.yml"

# Intant name variable
intent_name = "faq-hort-garlic-b0-pun"
...
with open(nlu_output_filename, "w") as file, open(domain_output_filename, "w") as file2:
    ...
    for key in df_sliced_dict.keys():
        print(key)
        name = df_sliced_dict[key]['questoions'].iloc[0].strip().replace(" ", "-")
